...
public class Constants {
    ...
    public static String  UPLOAD_USER_FOLDER = "upload/user/";

    public static final String APP_ENCODING = "iso-8859-1";
    public static final String WEB_EXPECTED_ENCODING = "utf-8";
    ...
    public static final String DEFAULT_USER_HEAD_URL = "http://192.168.191.1:8080/iplay/static/img/user/head_default.png";
}
